...
class Kinova(tfds.core.GeneratorBasedBuilder):
                    ...
                    "steps": tfds.features.Dataset(
                        {
                            ...
                            "action": tfds.features.Tensor(
                                shape=(8,),
                                dtype=np.float32,
                                doc="Robot action, consists of [3x EEF position,  3x EEF orientation yaw/pitch/roll, 1x gripper open/close position,  1x terminate episode].",
                            ),
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        """Define data splits."""
        # root_path = os.path.dirname(os.path.dirname(__file__)) + "/data"
